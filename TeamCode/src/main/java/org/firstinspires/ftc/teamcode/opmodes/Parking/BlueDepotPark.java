...
@Autonomous
public class BlueDepotPark extends AutoOpmode {
    //    public static double STONE_X = -40;
//    public static double STONE_Y = -21;

    @Override
    protected void setup() {
//        initialPose = new Pose2d(-36.0, 63.0, toRadians(270.0));
//        robot.drive.setPoseEstimate(initialPose);
//        AutoPaths.ALLIANCE = AutoPaths.Alliance.BLUE;
//        AutoPaths.SIDE = AutoPaths.Side.DEPOT;
    }
